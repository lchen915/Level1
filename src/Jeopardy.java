...
public class Jeopardy implements ActionListener {
	...
	private void start() {
		...
		JPanel header = createHeader ("Science and Technology");
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if (buttonPressed.equals(firstButton)) {
			...
			askQuestion("Who was the 20th US president?", "Garfield", 500);
		...
		if (buttonPressed.equals(secondButton)) {
			...
			askQuestion("Who was the 21st US president?", "Arthur", 1000);
